...
export default function WorldGlobeIcon (props: React.SVGProps<SVGSVGElement>): React.ReactElement {
  return <svg height={28} width={28} viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g
      fill="none"
      fillRule="evenodd"
      stroke="currentColor"
